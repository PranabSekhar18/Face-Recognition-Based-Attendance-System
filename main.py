...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': 'faceattecdance.appspot.com'
})
...
while True:
    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if counter == 1:
                # Get the Data
                studentInfo = db.reference(f'Students_data/{id}').get()
                print(studentInfo)
                # Get the Image from the storage
                blob = bucket.get_blob(f'Resized_images/{id}.jpg')
                ...
                if secondsElapsed > 30:
                    ref = db.reference(f'Students_data/{id}')
